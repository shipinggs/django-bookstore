...
urlpatterns = [
    ...
    url(r'^book/(?P<bid>[a-zA-Z0-9]+)/review-filter-newest$', views.review_filter_newest, name = 'review_filter_newest'),
    url(r'^book/(?P<bid>[a-zA-Z0-9]+)/review-filter-best$', views.review_filter_best, name = 'review_filter_best'),
