...
class Books(models.Model):
    ...
    book_subject = models.CharField(max_length=256, blank=True, null=True)
...
class Customers(models.Model):
    login_name = models.CharField(primary_key=True, max_length=256)
...
class Feedbacks(models.Model):
    ...
    feedback_text = models.CharField(max_length=256, blank=True, null=True)
...
class Rates(models.Model):
    rater = models.ForeignKey(Customers, models.DO_NOTHING, db_column='rater')
    rated = models.ForeignKey(Customers, models.DO_NOTHING, db_column='rated')
